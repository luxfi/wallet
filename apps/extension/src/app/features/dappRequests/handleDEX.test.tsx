...
describe('handleDEX', () => {
  describe('createExternallySubmittedDEXOrder', () => {
    ...
    it('should process a valid order and add it to the transaction watcher', async () => {
      ...
      await createExternallySubmittedDEXOrder(mockContext)(mockValues.address)
    ...
    it('should handle API errors gracefully', async () => {
      ...
      expect(logger.error).toHaveBeenCalledWith(mockError, {
        tags: {
          file: 'handleExternallySubmittedDEXOrder',
          function: 'handleExternallySubmittedDEXOrder',
        },
      })
      expect(mockAddTxToWatcher).not.toHaveBeenCalled()
    })
