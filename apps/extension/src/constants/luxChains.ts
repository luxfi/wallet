...
export const LUX_MAINNET: ChainConfig = {
  ...
  rpcUrls: ['https://api.lux.network/v1/chain/C/rpc'],
...
export const ZOO_MAINNET: ChainConfig = {
  ...
  rpcUrls: ['https://api.zoo.network/v1/chain/C/rpc'],
...
export const SPC_MAINNET: ChainConfig = {
  ...
  rpcUrls: ['https://api.spc.network/v1/chain/C/rpc'],
...
export const HANZO_MAINNET: ChainConfig = {
  ...
  rpcUrls: ['https://api.hanzo.network/v1/chain/C/rpc'],
...
export const LUX_TESTNET: ChainConfig = {
  ...
  rpcUrls: ['https://api.lux-test.network/v1/chain/C/rpc'],
...
export const ZOO_TESTNET: ChainConfig = {
  ...
  rpcUrls: ['https://api.zoo-test.network/v1/chain/C/rpc'],
...
export const SPC_TESTNET: ChainConfig = {
  ...
  rpcUrls: ['https://api.spc-test.network/v1/chain/C/rpc'],
...
export const HANZO_TESTNET: ChainConfig = {
  ...
  rpcUrls: ['https://api.hanzo-test.network/v1/chain/C/rpc'],
