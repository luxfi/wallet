...
const FALLBACK_LIQUIDITY: TrustedDApp[] = [
  {
    name: "Liquid DEX",
    url: "https://swap.satschel.com",
    description: "Liquid EVM DEX.",
    chainIds: [],
    category: "dex",
  },
  {
    name: "Liquidity Exchange",
    url: "https://exchange.satschel.com",
    description: "Liquidity ATS.",
    chainIds: [],
    category: "exchange",
  },
]
...
function selectFallback(appDomain: string | undefined): TrustedDApp[] {
  ...
  if (d.endsWith("satschel.com") || d.endsWith("liquidity.io")) {
