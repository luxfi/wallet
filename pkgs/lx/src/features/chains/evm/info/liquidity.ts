...
export const LIQUIDITY_CHAIN_INFO = {
  ...
  urlParam: 'liquidity',
  rpcUrls: {
    [RPCType.Default]: { http: ['https://rpc.main./rpc'] },
    [RPCType.Interface]: { http: ['https://rpc.main./rpc'] },
  },
...
export const LIQUIDITY_TESTNET_CHAIN_INFO = {
  ...
  rpcUrls: {
    [RPCType.Default]: { http: ['https://rpc.test./rpc'] },
    [RPCType.Interface]: { http: ['https://rpc.test./rpc'] },
  },
  wrappedNativeCurrency: {
    name: 'Wrapped ',
    symbol: 'W',
